...
video = cv2.VideoCapture('babywake.avi')
...
while(True):
	...
	ret,frame = video.read()
	# frame = imutils.resize(frame, width=900 , height=675)
	oriframe = frame
	...
	# Perform the actual detection by running the model with the iord('q'mage as input
